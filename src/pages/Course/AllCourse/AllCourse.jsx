  ...
  const columns = [
    ...
    },
    {
      ...
      render: (mode) => (
        <span
          className={
            mode.toLowerCase() === "online" ? "status-online" : "status-offline"
          }
        >
          {mode.toLowerCase()}
        </span>
    ...
    },
    {
      ...
      render: (_, record) => (
        <div className="course_buttons">
          <Popup
            trigger={
              <button type="button" className="course_button_edit">
                <MdModeEditOutline />
              </button>
            }
            modal
              ...
              <div className="popup_container">
                ...
                >
                  ...
                  <div className="all_course_input">
                    ...
                    <Form.Item name="enrollmentDate" label="End register date">
                      <input type="date" className="all_course_form" />
                    </Form.Item>
                  </div>
                  <div className="all_course_input">
