...
//     dataIndex: 'action',
//     render: (_, record) => (
//       <Button type="link" danger onClick={() => handleDelete(record.login.uuid)}>
//         Delete
//       </Button>
//     ),
//   },
...
//     const newData = data.filter((item) => item.login.uuid !== uuid);
//     setData(newData);
//   };
  ...
  const columns = [
    {
      ...
      sorter: true,
      width: "7%",
      render: (_, __, index) => index + 1, // Chỉ số hàng
    },
    {
      title: "Name",
      dataIndex: "name",
    ...
    },
    {
      ...
      dataIndex: "action",
      render: (_, record) => (
        <Button type="link" danger onClick={() => handleDelete(record.login.uuid)} className="student_button_delete">
          <RiDeleteBin6Line/>
        </Button>
      ),
      width: "10%",
